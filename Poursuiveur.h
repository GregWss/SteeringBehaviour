...
//  Name:   Poursuiveur.h
//
//  Desc:   Definition of a entity who use steering behaviors to move
//
//  Author: Baptiste ROUPAIN & Geregory WEISS
//
//------------------------------------------------------------------------
#include "Vehicle.h"
...
private:
	...
	Poursuiveur(const Poursuiveur&);
	Poursuiveur& operator=(const Poursuiveur&);


public:

	Poursuiveur(GameWorld* world,
		Vector2D position,
		double    rotation,
		Vector2D velocity,
		double    mass,
